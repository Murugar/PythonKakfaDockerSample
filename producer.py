...
topic = kafka_client.topics['test']  # This will create the topic if it does not exist
...
with topic.get_producer(delivery_reports=True) as producer:  # Create Kafka producer on the given topic
    while True:
